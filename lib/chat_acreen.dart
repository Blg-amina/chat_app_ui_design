import 'package:chat_app_ui_design/message_send.dart';
      ...
      appBar: AppBar(
        ...
        title: Row(
          children: [
            ...
            const SizedBox(width: 8), // قربنا النص للصورة
            const Column(
        ...
        child: SafeArea(
          child: Column(
            ...
            children: [
              ...
              chatMessage('Thank you Sir  ', const Color(0xff373E4E)),
              const SizedBox(height: 8),
              chatMessage('For the Informations', const Color(0xff373E4E)),
              // last
              const Spacer(),
